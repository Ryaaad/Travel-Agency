...
const Landing = () => {
    return ( 
        <div className="flex gap-[150px] overflow-hidden relative h-[85vh] items-center  ">
            ...
            <div className=' absolute top-[45%] rounded-full translate-x-[-50%] left-[50%] w-[40px] h-[40px]
            ...
            <h1 className="text-8xl tracking-wide font-semibold leading-[90px] " >Africa</h1>
            ...
            <h1 className="absolute  top-[10%] text-[#ffffff20] text-6xl tracking-wide font-semibold
             leading-[90px] " >America</h1>
              <h1 className="absolute bottom-[10%] text-[#ffffff20] text-6xl tracking-wide font-semibold 
            ...
            <Cart {...Africa[3]} view={true}></Cart> 
                {Africa.map(i=>{
                    return <Cart {...i} view={false}></Cart>
                })}
            </div>
            <div className="absolute bottom-[5%] left-[49%] flex gap-[400px] items-center ">
